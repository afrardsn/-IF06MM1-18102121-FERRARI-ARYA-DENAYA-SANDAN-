package com.ferrariarya_18102121.praktikum5
...
import kotlinx.android.synthetic.main.activity_pratice5.*

class Pratice5Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_pratice5)
        setupPermissions()
        btnProdi.setOnClickListener {
            val namaProdi = inputProdi.text.toString()
            if (namaProdi.isEmpty()) {
                inputProdi.error = getString(R.string.errror)
                return@setOnClickListener
            }
            val moveWithDataIntent = Intent(this@Pratice5Activity, Practice5ReadDataActivity::class.java)
