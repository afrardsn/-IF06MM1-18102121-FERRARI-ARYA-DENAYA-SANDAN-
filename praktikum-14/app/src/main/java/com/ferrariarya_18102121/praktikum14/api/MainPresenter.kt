package com.ferrariarya_18102121.praktikum14.api
...
import com.ferrariarya_18102121.praktikum14.model.Message
import com.ferrariarya_18102121.praktikum14.model.QuoteResponse
...
class MainPresenter(
    ...
    fun getMyQuotes(token: String?) {
        GlobalScope.launch(context.main) {
            try {
                ApiMain().services.getMyQuotes("Bearer " + token)
